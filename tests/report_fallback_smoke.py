...
class _FakeResponse:
    output_text = '{"ru":"⬛ Вечерняя сводка по рынку угля КНР за 7 июля 2026 года\\n\\nПериод: с 07:00 7 июля 2026 года до 20:00 7 июля 2026 года по Пекину\\n\\n⬛ Картина дня\\nАвария на шахте в Чанчжи остается главным операционным событием периода: остановлена только затронутая шахта, соседние рудники работают штатно. Для закупок это важно из-за возможных точечных проверок и краткосрочных ограничений предложения.\\n\\n⬛ Новости из источников\\n▪️ Mysteel\\n1. В районе Чанчжи произошла авария с обрушением кровли и гибелью человека; остановлена только затронутая шахта.\\nСсылка: https://coal.mysteel.com/a/26070709/SAFETY123.html\\n\\n⬛ Иные новости\\nСвежих релевантных новостей по отслеживаемым компаниям за период не найдено.","zh":"⬛ 中国煤炭市场晚报\\n日期：2026年7月7日\\n\\n⬛ 今日概况\\n长治煤矿事故是本期主要运营事件。\\n\\n⬛ 来源新闻\\n▪️ Mysteel\\n1. 长治区域矿井发生顶板事故致人员遇难。\\n链接：https://coal.mysteel.com/a/26070709/SAFETY123.html\\n\\n⬛ 其他新闻\\n本期未发现跟踪公司相关的新消息。"}'
...
def main():
    ...
    assert "Иные новости" in result["ru"], result["ru"]
